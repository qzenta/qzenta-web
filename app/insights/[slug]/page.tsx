  ...
  return (
    <>
      <section className="px-4 sm:px-6 lg:px-8 pt-20 pb-8 max-w-7xl mx-auto">
        ...
        <p className="mt-5 text-lg text-gray-600 max-w-2xl leading-relaxed">{post.excerpt}</p>
      </section>
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-24 max-w-3xl mx-auto">
        <div className="border-t border-gray-200 pt-10 space-y-5">
          {paragraphs.map((para, i) => {
            if (para.startsWith("## ")) {
              return (
                <h2 key={i} className="text-xl font-semibold text-gray-900 pt-4">
                  {para.replace("## ", "")}
                </h2>
              );
            }
        ...
        <div className="mt-16 pt-8 border-t border-gray-200">
          <p className="text-sm text-gray-600">
            ...
            <Link href="/contact" className="text-emerald-600 hover:text-emerald-700 transition-colors">
              Get in touch
            </Link>{" "}
            and we&apos;ll help.
          </p>
