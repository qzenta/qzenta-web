...
export default function TermsPage() {
  return (
    <section className="px-4 sm:px-6 lg:px-8 py-20 max-w-3xl mx-auto">
      ...
      <h1 className="text-3xl font-bold text-onyx-50 mb-2">Terms of Service</h1>
      <p className="text-sm text-onyx-300 mb-8">Last updated: May 2026</p>
      ...
      <div className="space-y-6 text-onyx-500 text-sm leading-relaxed">
        ...
        <div>
          <h2 className="text-onyx-50 font-semibold mb-2">Use of the website</h2>
          <p>
        ...
        <div>
          <h2 className="text-onyx-50 font-semibold mb-2">Intellectual property</h2>
          <p>
        ...
        <div>
          <h2 className="text-onyx-50 font-semibold mb-2">Limitation of liability</h2>
          <p>
        ...
        <div>
          <h2 className="text-onyx-50 font-semibold mb-2">Governing law</h2>
          <p>
