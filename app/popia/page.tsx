  ...
  return (
    <>
      <section className="px-4 sm:px-6 lg:px-8 pt-20 pb-12 max-w-7xl mx-auto">
        ...
        <h1 className="text-4xl sm:text-5xl font-bold text-slate-100">POPIA Notice</h1>
      ...
      <section className="px-4 sm:px-6 lg:px-8 pb-24 max-w-3xl mx-auto">
        <div className="space-y-10 text-slate-400 leading-relaxed">
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-100 mb-3">3. Why we collect it</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-100 mb-3">4. How we protect your information</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-100 mb-3">5. Sharing your information</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-100 mb-3">6. Retention</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-100 mb-3">7. Your rights</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-slate-100 mb-3">8. Contact us</h2>
            <p>
              For any POPIA-related enquiries, to exercise your rights, or to lodge a complaint,
              contact our Information Officer:
            </p>
            <div className="mt-4 bg-gray-800 rounded-lg p-6 border border-gray-700 text-sm space-y-1">
              <p className="text-slate-100 font-medium">Qzenta (Pty) Ltd — Information Officer</p>
              <p>Email:{" "}
                <a href="mailto:info@qzenta.com" className="text-emerald-500 hover:text-emerald-400 transition-colors">
                  info@qzenta.com
                </a>
            ...
            <p className="mt-4 text-sm">
              ...
              <span className="text-slate-300">Information Regulator of South Africa</span> at{" "}
              <span className="text-slate-300">inforeg.org.za</span> if you believe your rights
