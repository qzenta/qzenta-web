  ...
  return (
    <>
      <section className="px-4 sm:px-6 lg:px-8 pt-20 pb-12 max-w-7xl mx-auto">
        ...
        <h1 className="text-4xl sm:text-5xl font-extrabold text-onyx-50 tracking-tight">POPIA Notice</h1>
        ...
        <p className="mt-2 text-sm text-onyx-500">Last updated: May 2026</p>
      </section>

      <section className="px-4 sm:px-6 lg:px-8 pb-24 max-w-3xl mx-auto">
        <div className="space-y-10 text-onyx-500 leading-relaxed">

          <div>
            <h2 className="text-xl font-semibold text-onyx-50 mb-3">1. Who we are</h2>
            <p>
              ...
              at{" "}
              <a href="mailto:info@qzenta.com" className="text-spring-400 hover:text-spring-300 transition-colors">
                info@qzenta.com
              </a>.
            </p>
          </div>
          ...
          <div>
            <h2 className="text-xl font-semibold text-onyx-50 mb-3">2. Information we collect</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-onyx-50 mb-3">3. Why we collect it</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-onyx-50 mb-3">4. How we protect your information</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-onyx-50 mb-3">5. Sharing your information</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-onyx-50 mb-3">6. Retention</h2>
            <p>
          ...
          <div>
            <h2 className="text-xl font-semibold text-onyx-50 mb-3">7. Your rights</h2>
          ...
          <div>
            <h2 className="text-xl font-semibold text-onyx-50 mb-3">8. Contact us</h2>
            <p>
              For any POPIA-related enquiries, to exercise your rights, or to lodge a complaint,
              contact our Information Officer:
            </p>
            <div className="mt-4 bg-onyx-800 rounded-lg p-6 border border-onyx-700 text-sm space-y-1">
              <p className="text-onyx-50 font-medium">Qzenta (Pty) Ltd — Information Officer</p>
              <p>Email:{" "}
                <a href="mailto:info@qzenta.com" className="text-spring-400 hover:text-spring-300 transition-colors">
                  info@qzenta.com
                </a>
            ...
            <p className="mt-4 text-sm">
              ...
              <span className="text-onyx-500">Information Regulator of South Africa</span> at{" "}
              <span className="text-onyx-500">inforeg.org.za</span> if you believe your rights
        ...
        <div className="mt-16 pt-8 border-t border-onyx-700 flex flex-wrap gap-4 text-sm">
          <Link href="/privacy" className="text-spring-400 hover:text-spring-300 transition-colors">
            Privacy Policy
          </Link>
          <Link href="/terms" className="text-spring-400 hover:text-spring-300 transition-colors">
            Terms of Service
          </Link>
